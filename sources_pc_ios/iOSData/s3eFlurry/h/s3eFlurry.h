...
/**
 * @defgroup flurryapigroup S3E Flurry Extension API Reference
 *
 ...
 *
 *
 * @platnote{Android, android}  s3eFlurrySetSessionReportsOnCloseEnabled is not supported.
 * s3eFlurrySetSessionReportsOnPauseEnabled is not supported.
 * @endplatnote
 *
 * @platnote{Windows Phone 8, wp8}  s3eFlurrySetSessionReportsOnCloseEnabled is not supported.
 * s3eFlurrySetSessionReportsOnPauseEnabled is not supported.
 * @endplatnote
 */
...
/**
 * Ends the started Flurry session. This method must be called before application finish.
 *
 * @supported{
 *             @platform{Android,android}
 * }
