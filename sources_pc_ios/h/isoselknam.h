...
public:
	...
	void InitSelknam(IsoSelknamType _selknamType, bool bDeploySound = true, int overrideLevel = 0);
	void DeploySound(int soundType);
...
private:
	...
	bool bFixPawnOrientation;
	IsoEnemyType lastEnemyTypeTargeted;

	void SetOrientationTowardsNearestEnemySpot();
};
