...
{
	RetrieveTextureDataFromFile("atlas_common_0.tbn");
	RetrieveTextureDataFromFile("atlas_common_1.tbn");
	RetrieveTextureDataFromFile("atlas_common_2.tbn");
	RetrieveTextureDataFromFile("atlas_common_trial_0.tbn");
	RetrieveTextureDataFromFile("atlas_menu_01_0.tbn");
	RetrieveTextureDataFromFile("atlas_menu_01_1.tbn");
	RetrieveTextureDataFromFile("atlas_menu_02_0.tbn");
	RetrieveTextureDataFromFile("atlas_gamebackground_0.tbn");
	RetrieveTextureDataFromFile("atlas_worldmap_0.tbn");
	RetrieveTextureDataFromFile("atlas_terrain_0.tbn");
...
TextureData TextureHelper::GetTextureNamed(string fileName)
{
	...
	IwTrace(TEXHELP, ("STRING NOT FOUND!!! STRING NOT FOUND!!! STRING NOT FOUND!!! STRING NOT FOUND!!!"));
...
RenderData TextureHelper::GetRenderData(TextureData data, int cols, int rows, int index)
{
	RenderData ret;
	ret.bRotate = data.textureRotated;
...
{
	if(name == ATLAS_COMMON_0)         return atlas_common_0;
	if(name == ATLAS_COMMON_1)         return atlas_common_1;
	if(name == ATLAS_COMMON_2)         return atlas_common_2;
	if(name == ATLAS_COMMON_TRIAL)         return atlas_common_trial;
	if(name == ATLAS_GAMEBACKGROUND_0) return atlas_gamebackground_0;
	if(name == ATLAS_MENU_01_0)		   return atlas_menu_01_0;
	if(name == ATLAS_MENU_01_1)		   return atlas_menu_01_1;
	if(name == ATLAS_MENU_02_0)		   return atlas_menu_02_0;
	if(name == ATLAS_WORLDMAP)         return atlas_worldmap;
	if(name == ATLAS_ENEMY_01_1)       return atlas_enemy_01_1;
	if(name == ATLAS_ENEMY_01_2)       return atlas_enemy_01_2;
	if(name == ATLAS_ENEMY_02_1)       return atlas_enemy_02_1;
	if(name == ATLAS_ENEMY_02_2)       return atlas_enemy_02_2;
	if(name == ATLAS_ENEMY_03_1)       return atlas_enemy_03_1;
	if(name == ATLAS_ENEMY_04_1)       return atlas_enemy_04_1;
	if(name == ATLAS_ENEMY_04_2)       return atlas_enemy_04_2;
	if(name == ATLAS_ENEMY_05_1)       return atlas_enemy_05_1;
	if(name == ATLAS_ENEMY_06_1)       return atlas_enemy_06_1;
	if(name == ATLAS_ENEMY_07_1)       return atlas_enemy_07_1;
	if(name == ATLAS_ENEMY_07_2)       return atlas_enemy_07_2;
	if(name == ATLAS_SELKNAM_ARCHER_01_1) return atlas_selknam_archer_01_1;
	if(name == ATLAS_SELKNAM_ARCHER_01_2) return atlas_selknam_archer_01_2;
	if(name == ATLAS_SELKNAM_ARCHER_02_1) return atlas_selknam_archer_02_1;
	if(name == ATLAS_SELKNAM_ARCHER_02_2) return atlas_selknam_archer_02_2;
	if(name == ATLAS_SELKNAM_ARCHER_03_1) return atlas_selknam_archer_03_1;
	if(name == ATLAS_SELKNAM_ARCHER_03_2) return atlas_selknam_archer_03_2;
	if(name == ATLAS_SELKNAM_BOWLER_01_1) return atlas_selknam_bowler_01_1;
	if(name == ATLAS_SELKNAM_BOWLER_01_2) return atlas_selknam_bowler_01_2;
	if(name == ATLAS_SELKNAM_BOWLER_02_1) return atlas_selknam_bowler_02_1;
	if(name == ATLAS_SELKNAM_BOWLER_02_2) return atlas_selknam_bowler_02_2;
	if(name == ATLAS_SELKNAM_BOWLER_03_1) return atlas_selknam_bowler_03_1;
	if(name == ATLAS_SELKNAM_BOWLER_03_2) return atlas_selknam_bowler_03_2;
	if(name == ATLAS_SELKNAM_MAGE_01_1) return atlas_selknam_mage_01_1;
	if(name == ATLAS_SELKNAM_MAGE_01_2) return atlas_selknam_mage_01_2;
	if(name == ATLAS_SELKNAM_MAGE_02_1) return atlas_selknam_mage_02_1;
	if(name == ATLAS_SELKNAM_MAGE_02_2) return atlas_selknam_mage_02_2;
	if(name == ATLAS_SELKNAM_MAGE_03_1) return atlas_selknam_mage_03_1;
	if(name == ATLAS_SELKNAM_MAGE_03_2) return atlas_selknam_mage_03_2;
	if(name == ATLAS_SELKNAM_MELEE_01_1) return atlas_selknam_melee_01_1;
	if(name == ATLAS_SELKNAM_MELEE_01_2) return atlas_selknam_melee_01_2;
	if(name == ATLAS_SELKNAM_MELEE_02_1) return atlas_selknam_melee_02_1;
	if(name == ATLAS_SELKNAM_MELEE_02_2) return atlas_selknam_melee_02_2;
	if(name == ATLAS_SELKNAM_MELEE_03_1) return atlas_selknam_melee_03_1;
	if(name == ATLAS_SELKNAM_MELEE_03_2) return atlas_selknam_melee_03_2;
	if(name == ATLAS_TERRAIN_0) return atlas_terrain_0;
	if(name == ATLAS_PROPS_0) return atlas_props_0;
	if(name == ATLAS_PROPS_1) return atlas_props_1;
	if(name == ATLAS_PROPS_2) return atlas_props_2;
	if(name == ATLAS_FX_0) return atlas_fx_0;
	if(name == ATLAS_FX_1) return atlas_fx_1;
	if(name == ATLAS_FX_2) return atlas_fx_2;
...
{
	if(      strcmp(data.atlasFileName, "atlas_common_0")           == 0)	   return ATLAS_COMMON_0;
	else  if(strcmp(data.atlasFileName, "atlas_common_1")           == 0)      return ATLAS_COMMON_1;
	else  if(strcmp(data.atlasFileName, "atlas_common_2")           == 0)      return ATLAS_COMMON_2;
	else  if(strcmp(data.atlasFileName, "atlas_common_trial_0")           == 0)      return ATLAS_COMMON_TRIAL;
	else  if(strcmp(data.atlasFileName, "atlas_gamebackground_0")	== 0)      return ATLAS_GAMEBACKGROUND_0;
	else  if(strcmp(data.atlasFileName, "atlas_menu_01_0")		    == 0)      return ATLAS_MENU_01_0;
	else  if(strcmp(data.atlasFileName, "atlas_menu_01_1")		    == 0)      return ATLAS_MENU_01_1;
	else  if(strcmp(data.atlasFileName, "atlas_menu_02_0")		    == 0)      return ATLAS_MENU_02_0;
	else  if(strcmp(data.atlasFileName, "atlas_worldmap_0") 	    == 0)      return ATLAS_WORLDMAP;
	else  if(strcmp(data.atlasFileName, "atlas_terrain_0")	        == 0)      return ATLAS_TERRAIN_0;
