...
void IsoObject::setIsoPosition()
{
	...
	float myPosY = position.y + ((layer - 1) * 16) + 16;

	float newIsoXPos = 0;
	float newIsoYPos = 0;

	Utils::GetIsoSpaceCoord(myPosX, myPosY, isoFormulaXOffset, isoFormulaYOffset, &newIsoXPos, &newIsoYPos);
